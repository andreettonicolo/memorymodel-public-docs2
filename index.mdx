...
**___Outputs from these strategies are aggregated via a Fusion Layer responsible for deduplication and final ranking.___**
...
<Columns cols={2}>
  ...
  <Card title="Examples" icon="lightbulb-cfl-on" color="#b26eff" href="https://docs.memorymodel.dev/examples/agent-integration-examples">
    If you want a simple example of how to use it.
  </Card>
</Columns>